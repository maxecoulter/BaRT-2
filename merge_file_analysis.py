...
for line in open(path+short_read_input):
	line1=line.strip("\n").split("\t")
...
vennlist=[short_read_sj,long_sjs]
venn_names=("Illumina","Pacbio merged")
venn_diagram(path2+"Splice junctions.png",vennlist,venn_names)


#Now lets analyse some splice junctions

with open(infile3) as bedfile:
	for line in bedfile:
		bed = Bedline(line)
"""
